...
using Neuralium.Shell.Controllers.Dto.Parameters;
...
namespace Neuralium.Shell.Controllers {
	...
	public class DebugController {
		...
		public IActionResult GetGenesisBlock([FromBody] GetGenesisBlockParameters parameters) {
			...
			//return new ObjectResult(new GenesisBlockDto{iii = task.Result, Uuid = neuraliumBlockChainController.Router.NeuraliumBlockChainController.blockChain.GetBlockId(),CreatedTime = DateTime.Now});
			return null;
		}
