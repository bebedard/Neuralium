...
namespace Neuralia.Blockchains.Common.Classes.Blockchains.Common.Workflows.Chain.ChainSync.Messages.V1.Digest {
	public abstract class ClientRequestDigestFile : NetworkMessage<IBlockchainEventsRehydrationFactory>, ISyncDataRequest<DigestFilesInfoSet<DataSliceInfo>, DataSliceInfo, int, ChannelFileSetKey> {

		public int Id { get; set; }

		public DigestFilesInfoSet<DataSliceInfo> SlicesInfo { get; } = new DigestFilesInfoSet<DataSliceInfo>();
		...
		protected override ComponentVersion<SimpleUShort> SetIdentity() {
			return (ChainSyncMessageFactoryIds.REQUEST_DIGEST_FILE, 1, 0);
		}
