...
using Neuralia.STUN.Attributes;
using System.IO;
...
namespace Neuralia.STUN
{
    ...
    /// <summary>
    /// Neuralia.STUN client querying result
    /// </summary>
    public class STUNQueryResult
    {
        ...
        /// <summary>
        /// The socket that used to communicate with Neuralia.STUN server
        /// </summary>
    ...
    /// <summary>
    /// Implements a RFC3489 Neuralia.STUN client.
    /// </summary>
