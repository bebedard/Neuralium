...
namespace Neuralia.Data.HashFunction.xxHash.Utilities
{
    /// <summary>
        ...
        : IHashValue
    {
        ...
        public HashValue(IEnumerable<byte> hash, int bitLength)
        {
            ...
            this.Hash = CoerceToArray(hash, bitLength);
        ...
        {
            return new BitArray(this.Hash) {
                Length = this.BitLength
            };
        }
        ...
        /// </returns>
        public string AsHexString() => this.AsHexString(false);
        ...
        {
            var stringBuilder = new StringBuilder(this.Hash.Length);
            var formatString = uppercase ? "X2" : "x2";

            foreach (var byteValue in this.Hash)
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 31) ^ this.BitLength.GetHashCode();

                foreach (var value in this.Hash)
        ...
        {
            return this.Equals(obj as IHashValue);
        }
        ...
        {
            if (other == null || other.BitLength != this.BitLength)
                return false;
