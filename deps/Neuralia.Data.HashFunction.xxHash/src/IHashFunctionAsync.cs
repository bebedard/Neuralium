...
namespace Neuralia.Data.HashFunction.xxHash
{
        ...
        : IHashFunction
    {
        ...
        Task<IHashValue> ComputeHashAsync(RecyclableMemoryStream data);
        ...
        Task<IHashValue> ComputeHashAsync(RecyclableMemoryStream data, CancellationToken cancellationToken);
    }
}
