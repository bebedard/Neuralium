...
namespace Neuralia.BouncyCastle.extra.Utils {
	internal static class SpanPack {
		...
		internal static ushort BE_To_UInt16(Span<byte> bs) {
			uint n = ((uint) bs[0] << 8) | bs[1];

			return (ushort) n;
		}

		internal static ushort BE_To_UInt16(Span<byte> bs, int off) {
			uint n = ((uint) bs[off] << 8) | bs[off + 1];
		...
		internal static uint BE_To_UInt32(Span<byte> bs) {
		...
		internal static void BE_To_UInt32(Span<byte> bs, int off, uint[] ns) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static void UInt64_To_BE(ulong[] ns, Span<byte> bs, int off) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static ulong BE_To_UInt64(Span<byte> bs) {
		...
		internal static ulong BE_To_UInt64(Span<byte> bs, int off) {
		...
		internal static void BE_To_UInt64(Span<byte> bs, int off, ulong[] ns) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static ushort LE_To_UInt16(Span<byte> bs) {
			uint n = bs[0] | ((uint) bs[1] << 8);

			return (ushort) n;
		}

		internal static ushort LE_To_UInt16(Span<byte> bs, int off) {
			uint n = bs[off] | ((uint) bs[off + 1] << 8);
		...
		internal static void UInt32_To_LE(uint[] ns, Span<byte> bs, int off) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static uint LE_To_UInt32(Span<byte> bs) {
			return bs[0] | ((uint) bs[1] << 8) | ((uint) bs[2] << 16) | ((uint) bs[3] << 24);
		}
		...
		internal static void LE_To_UInt32(Span<byte> bs, int off, uint[] ns) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static void LE_To_UInt32(Span<byte> bs, int bOff, uint[] ns, int nOff, int count) {
		...
		internal static uint[] LE_To_UInt32(Span<byte> bs, int off, int count) {
		...
		internal static void UInt64_To_LE(ulong[] ns, Span<byte> bs, int off) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static void UInt64_To_LE(ulong[] ns, int nsOff, int nsLen, Span<byte> bs, int bsOff) {
		...
		internal static ulong LE_To_UInt64(Span<byte> bs) {
		...
		internal static ulong LE_To_UInt64(Span<byte> bs, int off) {
		...
		internal static void LE_To_UInt64(Span<byte> bs, int off, ulong[] ns) {
			for(int i = 0; i < ns.Length; ++i) {
		...
		internal static void LE_To_UInt64(Span<byte> bs, int bsOff, ulong[] ns, int nsOff, int nsLen) {
			for(int i = 0; i < nsLen; ++i) {
