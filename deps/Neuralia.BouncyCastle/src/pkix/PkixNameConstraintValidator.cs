...
namespace Org.BouncyCastle.Pkix
{
        ...
        private ISet IntersectIPRange(byte[] ipWithSubmask1, byte[] ipWithSubmask2)
    {
        ...
        private byte[] IpWithSubnetMask(byte[] ip, byte[] subnetMask)
        {
            ...
            System.Array.Copy(ip, 0, temp, 0, ipLength);
            System.Array.Copy(subnetMask, 0, temp, ipLength, ipLength);
            return temp;
        }
            ...
            byte[] ipWithSubmask2)
    {
        ...
        System.Array.Copy(ipWithSubmask1, 0, ip1, 0, ipLength);
        System.Array.Copy(ipWithSubmask1, ipLength, subnetmask1, 0, ipLength);

        byte[] ip2 = new byte[ipLength];
        byte[] subnetmask2 = new byte[ipLength];
        System.Array.Copy(ipWithSubmask2, 0, ip2, 0, ipLength);
        System.Array.Copy(ipWithSubmask2, ipLength, subnetmask2, 0, ipLength);
        return new byte[][]
        ...
        private bool IsIPConstrained(byte[] ip, byte[] constraint)
        {
            ...
            System.Array.Copy(constraint, ipLength, subnetMask, 0, ipLength);
